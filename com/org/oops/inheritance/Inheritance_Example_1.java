...
//This program is used to illustrate the inheritance concept
...
public class Inheritance_Example_1 extends Parent {
	// creating main method
	public static void main(String[] args) {
		// Through inheritance you can use the parent class Members in the child class
		// creating child class object
		Inheritance_Example_1 obj = new Inheritance_Example_1();
