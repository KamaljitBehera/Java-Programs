...
//		calling the static method
		...
		/*
		 * Explanation:- Because when we try to override the static method of parent
		 * class with the child class the child class method content is being hide in
		 * parent implementations so we get the output from parent implementation This
